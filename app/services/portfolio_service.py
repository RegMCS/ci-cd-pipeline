...
class PortfolioService:
    ...
    def get_portfolio_price(
        self, portfolio_id: str, target_date: date
    ) -> PortfolioPriceResponse:
    ...
    def get_correlation(
        self, portfolio_id1: str, portfolio_id2: str, start_date: date, end_date: date
    ) -> CorrelationResponse:
    ...
    def get_tracking_error(
        self, portfolio_id: str, benchmark_id: str, start_date: date, end_date: date
    ) -> TrackingErrorResponse:
